...
By default, \Rpackage{Rcade}'s prior belief is that DE and ChIP-seq statuses are independent. This is almost certainly not true, as genes with ChIP-seq signal are more likely to be DE than other genes.
...
Rcade <- RcadeAnalysis(DE, ChIPannoZones, annoZoneGeneidName="ENSG",
	...
	shift = 0, cl=cl, DE.prior=DE.prior, prior.mode=prior.mode, prior=prior,
	DElookup=DElookup)
Rcade
@
